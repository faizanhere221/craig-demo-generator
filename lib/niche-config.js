...
export const nicheConfig = {
  ...
  'bathroom-lovable': {
    ...
    titlePlural: "Bathroom Renovation Services",
    primaryColor: "#0ea5e9",
    primaryDark: "#0369a1",
    accentColor: "#0ea5e9",
    services: [
      { title: "Full Bathroom Renovations", icon: "🚿", description: "Complete bathroom transformations from dated to modern. Quality fixtures, tiling, and finishes." },
      { title: "Ensuite Renovations", icon: "🛁", description: "Create a luxurious ensuite retreat. Custom vanities, frameless showers, and premium fittings." },
      { title: "Tiling & Waterproofing", icon: "🧱", description: "Expert tiling and waterproofing to industry standards. Beautiful results that last for decades." },
      { title: "Vanity & Storage", icon: "🪞", description: "Custom vanities and smart storage solutions to maximise your bathroom space." },
      { title: "Shower Screens & Baths", icon: "✨", description: "Frameless shower screens, freestanding baths, and modern fixtures to elevate your bathroom." },
      { title: "Plumbing & Electrical", icon: "🔧", description: "Licensed plumbing and electrical work included. Full compliance with Australian building codes." }
    ],
