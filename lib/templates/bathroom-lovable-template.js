...
<meta name="description" content="${companyName} - Premium bathroom renovations in ${city}, ${state}. Licensed builder with warranty insurance. Call ${phone} for a free quote.">
  ...
  <div class="container">
    <div class="nav-inner">
      ...
      <div class="nav-cta">
        ...
        <a href="tel:${phoneClean}" class="btn-gold" data-track="phone_click">
...
<section class="hero">
  ...
  <div class="container">
    <div class="hero-content">
      ...
      <div class="hero-btns">
        <a href="tel:${phoneClean}" class="btn-gold-lg" data-track="phone_click">
          <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
          Call ${ownerName}
        </a>
...
<section id="areas" class="areas">
  <div class="container">
    ...
    <div class="areas-grid" style="grid-template-columns: 1fr; max-width: 360px; margin: 0 auto;">
      <div class="area-card">
        <div class="area-icon">
          <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
        </div>
        <h3>${city} &amp; Surrounds</h3>
        <p>Servicing ${city} and surrounding suburbs.</p>
      </div>
    </div>
  </div>
</section>
...
<section id="contact" class="contact">
  <div class="container">
    ...
    <div class="contact-grid">
      <a href="tel:${phoneClean}" class="contact-card" data-track="phone_click">
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
        <h4>Call Us</h4>
        <p>${phone}</p>
      </a>
  ...
  <div class="container">
    <div class="footer-grid">
      <div class="footer-brand">
        ...
        <p>Licensed builder specialising in premium bathroom renovations across ${city}.</p>
      </div>
