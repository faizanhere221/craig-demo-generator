...
.testimonial-card{background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:16px;padding:36px;transition:all .3s}
.testimonial-card:hover{background:rgba(255,255,255,0.08);border-color:rgba(59,130,246,0.3)}
.testimonial-card .stars{color:var(--accent);font-size:18px;margin-bottom:20px}
.testimonial-card p{color:rgba(255,255,255,0.8);font-size:16px;line-height:1.75;font-style:italic;margin-bottom:24px}
.testimonial-author{display:flex;align-items:center;gap:14px}
.author-avatar{width:48px;height:48px;background:var(--blue);border-radius:50%;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:700;font-size:18px}
.author-name{color:var(--white);font-weight:600;font-size:15px}
.author-loc{color:rgba(255,255,255,0.5);font-size:13px}
...
<section class="testimonials">
  <div style="text-align:center;max-width:700px;margin:0 auto 20px">
    ...
    <p class="section-sub" style="margin:0 auto">Real reviews from real customers across ${city}.</p>
  </div>
  <div class="testimonial-grid">
    <div class="testimonial-card">
      <div class="stars">★★★★★</div>
      <p>"Absolutely brilliant job on our entire house. The team was professional, clean and the finish is perfect. Couldn't be happier with the result — highly recommend!"</p>
      <div class="testimonial-author">
        <div class="author-avatar">JS</div>
        <div><div class="author-name">Jenny S.</div><div class="author-loc">${city}, ${state}</div></div>
      </div>
    </div>
    <div class="testimonial-card">
      <div class="stars">★★★★★</div>
      <p>"Used them for our office repaint and they worked around our business hours perfectly. Fast, clean, and the quality is outstanding. Will definitely use again."</p>
      <div class="testimonial-author">
        <div class="author-avatar">MP</div>
        <div><div class="author-name">Mark P.</div><div class="author-loc">${city}, ${state}</div></div>
      </div>
    </div>
    <div class="testimonial-card">
      <div class="stars">★★★★★</div>
      <p>"Third time using these guys and they never disappoint. Fair pricing, great communication, and the attention to detail is second to none. True professionals."</p>
      <div class="testimonial-author">
        <div class="author-avatar">LT</div>
        <div><div class="author-name">Lisa T.</div><div class="author-loc">${city}, ${state}</div></div>
      </div>
    </div>
  </div>
</section>
