...
<meta name="description" content="${companyName} - Metal roofing specialists in ${city}, ${state}. New roofs, replacements, repairs & ventilation. Call ${optimoPhone} for a free quote.">
...
<nav class="navbar" id="navbar">
  <div class="container navbar-inner">
    ...
    <div class="navbar-links">
      ...
      <a href="tel:${optimoPhoneClean}" class="btn-primary" data-track="phone_click">
...
<div class="mobile-menu">
  ...
  <a href="#why-us">Why Us</a>
  <a href="#contact">Contact</a>
  <a href="tel:${optimoPhoneClean}" class="btn-primary" data-track="phone_click" style="margin-top: 8px;">
